...
from util.drawer_package.d0_util_3d import find_pair_point_in_Traj_and_draw
...
def draw_1(fig, ax):
    ...
    return "F:\\毕业设计大文件夹\\picture\\ppt图片\\Fig3-10\\1.jpg"
...
def draw_2(fig, ax):
    ...
    ax.text(min_point[0] + .9, min_point[1]-0.5, min_point[2], r'$DTW-BDS(r_0)$', color='0.1', fontsize=small_fontsize)
    return "F:\\毕业设计大文件夹\\picture\\ppt图片\\Fig3-10\\2.jpg"
...
def draw_3(fig, ax):
    ...
    ax.text(min_point[0] +b_x, min_point[1]+b_y, min_point[2], '', color='0.1', fontsize=small_fontsize)
    return "F:\\毕业设计大文件夹\\picture\\ppt图片\\Fig3-10\\3.jpg"
...
def draw_4(fig, ax):
    ...
    return "F:\\毕业设计大文件夹\\picture\\ppt图片\\Fig3-10\\4.jpg"
...
def draw_5(fig, ax):
    ...
    ax.text(min_point[0] +b_x-0.6, min_point[1] +b_y, min_point[2], r'', color='0.1', fontsize=small_fontsize)
    return "F:\\毕业设计大文件夹\\picture\\ppt图片\\Fig3-10\\5.jpg"
...
if __name__=='__main__':
    ...
    if dr_3d == 1:
        ...
        # plt.ylim(0, 2)
        ax.set_zlim(0, 10)
        ax.view_init(elev=40, azim=170)  # 调整视角
        plt.savefig(path, dpi=500)
        plt.show()

        # 裁剪
        # print('裁剪中...')
        # path = "F:\\毕业设计大文件夹\\picture\\ppt图片\\Fig3-10\\"
        # m_files = ['0.jpg', '1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', ]
