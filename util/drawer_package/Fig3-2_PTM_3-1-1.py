...
if __name__=='__main__':
    ...
    plt.text(S[1][0] - 0.3, S[1][1] - 1.5, S_label[1], fontsize=m_fontsize, color='0.6')
    plt.text(S[2][0] - 0.3, S[2][1] - 1.5, S_label[2], fontsize=m_fontsize, color='0.6')
    for i in range(3, len(S)):
        plt.text(S[i][0]-0.3, S[i][1]-1.5, S_label[i], fontsize=m_fontsize, color='0.6')
